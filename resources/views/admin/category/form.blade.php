<div class="container">
    <div class="">
        <div class="row m-0  w-100">
            ...
            <div class="col-6 fv-row fv-plugins-icon-container">
                <label class="fs-12 fw-semibold form-label mt-3">
                    <span class="required">Content h1</span>
                    <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" aria-label="Enter the contact's name." data-kt-initialized="1"></i>
                </label>
                <input type="text" class="form-control form-control-solid" name="h1" value=" @if(isset($data)) {{@$data->h1}}   @else {{@old('h1')}}       @endif" style="background:#dddddd ;">
                <div class="fv-plugins-message-container invalid-feedback"></div>
            </div>
        </div>
        <div class="row m-0  w-100">
        ...
        <div class="row m-0  w-100">
            ...
            <div class="  col-6  form-group mb-3 mt-6 ">
                ...
                <select class="form-control" name="parent_id" id="example-select" style="background-color: #dddddd;">
                    <option default value="0"> Please select a category</option>
