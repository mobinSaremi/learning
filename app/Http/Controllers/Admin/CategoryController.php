...
class CategoryController extends Controller
{
  ...
  public function postEdit($id, CategoryRequest $request)
  {
    ...
    if ($request->hasFile('image')) {
      ...
      if (true) {
        ...
        return Redirect::back()->with('error', 'The submitted fable is not correct');
      }
    } else {
  ...
  public function getDelete($id)
  {
    ...
    return Redirect::action([CategoryController::class, 'getList'])->with('success','Removed successfully');
  }
}
